    ...
    async def on_submit(self, interaction: discord.Interaction):
        try:
            ...
            if char_limit >= 0:
                ...
                save_leveling_data(data)
                await interaction.response.send_message(f"<:SucessLOGO:1407071637840592977> Character limit set to {char_limit}!", ephemeral=True)
            else:
    ...
    async def on_submit(self, interaction: discord.Interaction):
        try:
            ...
            if cooldown_value >= 0:
                ...
                save_leveling_data(data)
                await interaction.response.send_message(f"<:SucessLOGO:1407071637840592977> Character cooldown set to {cooldown_value} seconds!", ephemeral=True)
            else:
                await interaction.response.send_message("<:ErrorLOGO:1407071682031648850> Cooldown must be 0 or higher!", ephemeral=True)
        except ValueError:
            await interaction.response.send_message("<:ErrorLOGO:1407071682031648850> Please enter a valid number!", ephemeral=True)
    ...
    async def on_submit(self, interaction: discord.Interaction):
        try:
            ...
            if char_limit >= 0:
                ...
                data["leveling_settings"]["xp_settings"]["characters"]["character_limit"] = char_limit
                save_leveling_data(data)
                await interaction.response.send_message(f"<:SucessLOGO:1407071637840592977> Custom character limit set to {char_limit}!", ephemeral=True)
            else:
                await interaction.response.send_message("<:ErrorLOGO:1407071682031648850> Limit must be 0 or higher!", ephemeral=True)
        except ValueError:
            await interaction.response.send_message("<:ErrorLOGO:1407071682031648850> Please enter a valid number!", ephemeral=True)
