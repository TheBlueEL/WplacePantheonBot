...
class LevelCardManagerView(discord.ui.View):
    ...
    def update_buttons(self):
        """Update the buttons based on the current mode and permissions"""
        self.clear_items()
        ...
        if self.waiting_for_image:
            ...
            url_button = discord.ui.Button(
                label="Set URL",
                style=discord.ButtonStyle.secondary,
                emoji="<:URLLOGO:1407071963809054448>",
                disabled=not has_permission
            )
...
class CustomizationCategoryView(discord.ui.View):
    ...
    def get_embed(self):
        ...
        embed = discord.Embed(
            ...
            description=f"Manage {category_display.get(self.category, self.category.title())} customization permissions:",
            color=0xFFFFFF
        )
